...
- **MASP Indexer Snapshot:**  
  ...
  `658feb55efb04089f849ab40609bebc0c835f180` (HEAD, tag: `v1.4.4`, origin/master, origin/HEAD, master).
...
2. **Download the snapshot:**
   ...
   ```bash
   wget -O indexer_snapshot.sql https://indexer-snapshot-mainnet-namada.grandvalleys.com/public/indexer_snapshot.sql
   ```
