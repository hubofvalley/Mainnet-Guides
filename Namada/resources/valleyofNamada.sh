...
function show_guidelines() {
    ...
    echo "      - Guide: This option will show the logs for the validator node, helping you diagnose any issues."
    ...
    echo "      - Guide: Use this option to create a new wallet. Follow the prompts to set up your wallet securely."
    echo "   c. Restore Wallet: Restores a wallet from its seed phrase."
    echo "      - Guide: This option will help you restore a wallet from its seed phrase. Ensure you have your seed phrase ready."
    echo "   d. Query Balance: Queries the balance of a wallet."
    echo "      - Guide: This option will show the balance of a specified wallet. You can choose to query your own wallet or another wallet."
    echo "   e. Transfer (Transparent): Transfers tokens in a transparent manner."
    echo "      - Guide: Use this option to transfer tokens transparently. Ensure you have the recipient's address."
    echo "   f. Delegate NAM: Delegates NAM tokens to a validator."
    echo "      - Guide: This option will help you delegate NAM tokens to a validator. You can choose to delegate to Grand Valley, yourself, or another validator."
    echo "   g. Undelegate NAM: Undelegates NAM tokens from a validator."
    echo "      - Guide: Use this option to undelegate NAM tokens from a validator. You can choose to undelegate from yourself or another validator."
    echo "   h. Redelegate NAM: Redelegates NAM tokens to another validator."
    echo "      - Guide: This option will help you redelegate NAM tokens to another validator. Ensure you have the new validator's address."
    echo "   i. Withdraw Unbonded NAM: Withdraws unbonded NAM tokens."
    echo "      - Guide: Use this option to withdraw unbonded NAM tokens. Follow the prompts to complete the withdrawal."
    echo "   j. Claim Rewards: Claims rewards for staking."
    echo "      - Guide: This option will help you claim rewards for staking. Ensure you have the necessary information ready."
    echo "   k. Vote Proposal: Votes on a proposal."
    echo "      - Guide: Use this option to vote on a proposal. Follow the prompts to cast your vote."
    echo "   l. Create Shielded Payment Address: Creates a shielded payment address."
    echo "      - Guide: This option will help you create a shielded payment address. Follow the prompts to set up your shielded address."
    echo "   m. Transfer (Shielding): Transfers tokens to a shielded wallet."
    echo "      - Guide: Use this option to transfer tokens to a shielded wallet. Ensure you have the shielded address ready."
    echo "   n. Transfer (Shielded to Shielded): Transfers tokens between shielded wallets."
    echo "      - Guide: This option will help you transfer tokens between shielded wallets. Follow the prompts to complete the transfer."
    echo "   o. Transfer (Unshielding): Transfers tokens from a shielded wallet to a transparent wallet."
    echo "      - Guide: Use this option to transfer tokens from a shielded wallet to a transparent wallet. Ensure you have the transparent address ready."

    echo -e "${GREEN}Node Management:${RESET}"
    echo "   a. Restart Validator Node: Restarts the validator node."
    echo "      - Guide: This option will restart your validator node. Ensure you save any ongoing work."
    echo "   b. Stop Validator Node: Stops the validator node."
    echo "      - Guide: Use this option to stop your validator node. This will halt the node's operations."
    echo "   c. Delete Validator Node: Deletes the validator node."
    echo "      - Guide: This option will delete your validator node. Ensure you backup all important data before proceeding."
