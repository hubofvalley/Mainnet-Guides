...
- current namada node version: ${CYAN}v1.0.0 - v1.1.1 - v11.1.5 - v101.0.0${RESET}
- current cometbft version: ${CYAN}v0.37.15${RESET}
- current namada indexer version: ${CYAN}v3.0.2${RESET}
- current namada masp-indexer version: ${CYAN}v1.3.0${RESET}
"
...
function show_guidelines() {
    ...
    echo "   - Install Namada App (v101.0.0) to execute transactions without running a node"
...
function menu() {
    ...
    echo -e "${GREEN}6. Install the Namada App (v101.0.0) only to execute transactions without running a node${RESET}"
