...
- current namada indexer version: ${CYAN}v3.3.2${RESET}
...
function show_guidelines() {
    ...
    echo "   - Install Namada App (v101.1.1) to execute transactions without running a node"
...
function menu() {
    ...
    echo -e "${GREEN}6. Install the Namada App (v101.1.1) only to execute transactions without running a node${RESET}"
