...
docker compose exec postgres sh -c "pg_restore -d masp_indexer_local --clean /tmp/masp_indexer_snapshot.sql --verbose || true"
...
echo "8. Monitoring..."
docker logs --tail 50 -f namada-masp-indexer-transactions-1