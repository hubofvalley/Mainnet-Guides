...
- current story node version: ${CYAN}v1.1.0 - v1.1.1 - v1.2.0 - v1.2.1${RESET}
...
function install_story_app() {
    ...
    mkdir -p story-v1.2.1
    wget -O story-v1.2.1/story https://github.com/piplabs/story/releases/download/v1.2.1/story-linux-amd64
    cp story-v1.2.1/story $HOME/go/bin/story
...
function show_guidelines() {
    ...
    echo -e "${GREEN}Install Story App only: Installs the Story app (v1.2.1) for executing transactions without running the node.${RESET}"
...
function menu() {
    ...
    echo -e "${GREEN}4. Install the Story App (v1.2.1) only to execute transactions without running a node${RESET}"
