...
- current story node version: ${CYAN}v1.1.0 - v1.1.1 - v1.2.0 - v1.2.1 - v1.3.1 -v1.3.2${RESET}
...
function show_guidelines() {
    ...
    echo -e "${GREEN}Install Story App only: Installs the Story app (v1.3.1) for executing transactions without running the node.${RESET}"
