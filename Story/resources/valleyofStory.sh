...
- current story node version: ${CYAN}v1.1.0 - v1.1.1 - v1.2.0 - v1.2.1 - v1.3.1 - v1.3.2 - v1.3.3${RESET}
...
function install_story_app() {
    ...
    mkdir -p story-v1.3.2
    wget -O story-v1.3.2/story https://github.com/piplabs/story/releases/download/v1.3.2/story-linux-amd64
    cp story-v1.3.2/story $HOME/go/bin/story
...
function show_guidelines() {
    ...
    echo -e "${GREEN}Install Story App only: Installs the Story app (v1.3.2) for executing transactions without running the node.${RESET}"
...
function menu() {
    ...
    echo -e "${GREEN}4. Install the Story App (v1.3.2) only to execute transactions without running a node${RESET}"
