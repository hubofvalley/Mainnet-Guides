...
echo -e "c. ${YELLOW}v1.2.0${RESET} (${GREEN}Ovid${RESET} Upgrade height: 3,990,000)"
...
case $choice in
    ...
    b)
        ...
        ;;
    c)
        update_version "v1.2.0" "https://github.com/piplabs/story/releases/download/v1.2.0" 3990000
        ;;
    #d)
        #batch_update_version
        #;;
